...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        self.coreDataManager = CoreDataManager.sharedCoreDataManager //Initialize the shared instance of CoreData as soon as the app starts to get fastest response
        return true
    }
    ...
    func applicationWillResignActive(_ application: UIApplication) {
        ...
        //Try to save the application before we resign to the OS
        if !CoreDataManager.sharedCoreDataManager.saveContext(){
            print("ApplicationDelegate.applicationWillResignActive(). Couldn't save to CoreData before resigning application")
        }
    }
